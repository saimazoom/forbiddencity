...
public class Autowalk : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		controlador = this.GetComponent<CharacterMotor>();
	}
	...
	void Update () 
	{
		...
		if (isWalking) 
		{
			...
			//transform.Translate(rotation * direction); // Solo funciona este...
			controlador.inputMoveDirection = rotation * direction ;
			//controlador.SetVelocity (new Vector3 (5.0f, 0.0f, 0.0f));
			//controlador.inputMoveDirection = rotation * direction*100f;
		} else controlador.inputMoveDirection = new Vector3 (0.0f, 0.0f, 0.0f);
